...
void loop() {
     ...
     */
      ...
      rpm = (cdata[0]*256 + cdata[1]);  //data from byte 0 & 1 to variable "rpm"
      ect = (cdata[2]);  //data from byte 2 to variable "ect"
      lambda = (cdata[3]*256 + cdata[4]);  //data from byte 3 & 4 to variable "lambda"
      mappress = (cdata[5]);  //data from byte 5 to variable "mappress"
      battvoltage = (cdata[6]*256 + cdata[7]);  //data from byte 6 & 7 to variable "battvoltage"
